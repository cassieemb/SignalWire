...
# dial particular salesmen using name and group assigned in questions.json
...
# dial specific support department using name and group assigned in questions.json
